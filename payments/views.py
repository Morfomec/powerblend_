...
#     Checkout Page with coupon, wallet, COD and Razorpay handling.
#     """
...
#     #tax and shipping calculation, and disocunt
...
#                 if coupon.is_valid() and basket.total_price >= coupon.minimum_amount:
